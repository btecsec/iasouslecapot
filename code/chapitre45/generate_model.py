...
# Le dossier du chapitre est autonome : prepare_data.py est juste à côté.
# On l'ajoute au chemin pour que l'import fonctionne aussi quand le script
# est lancé depuis un autre répertoire (par exemple `pytest` à la racine).
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

from prepare_data import prepare_penguins_data  # noqa: E402
...
def generate_model():
    ...
    # 1. Utiliser la fonction du chapitre 34
